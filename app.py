...
.stButton>button:hover {background:#01579b!important;transform:scale(1.03)!important;}
.weather-box {
...
footer, .stCaption, .stMarkdown, .stText, .stSuccess {opacity:1!important;color:#0a192f!important;}
</style>
