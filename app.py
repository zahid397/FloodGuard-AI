...
/* Sidebar (soft gradient like MS Word sidebar) */
[data-testid="stSidebar"] {
    background: linear-gradient(180deg, #0078d7, #0099ff) !important;
    border-right: 3px solid #006bb3 !important;
}
[data-testid="stSidebar"] * {
...
/* Header & footer clear black text */
